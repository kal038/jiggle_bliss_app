        ...
        <div className="grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
            <main className="row-start-2 flex flex-col items-center gap-8 sm:items-start">
                ...
                <div className="flex flex-col items-center gap-4 sm:flex-row">
                    ...
                    <a
                        className="flex h-10 items-center justify-center gap-2 rounded-full border border-solid border-blue-500 bg-blue-500 px-4 text-sm text-white transition-colors hover:bg-blue-600 sm:h-12 sm:px-5 sm:text-base"
                        href="/login"
                    >
                        Log In
                    </a>
